...
struct Knob: View {
	...
	var pointerSize: CGFloat? // Optionally give a chance to set pointer size in construction.
...
// MARK: - EnvironmentExercise_Previews
